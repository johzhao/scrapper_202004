...
from .sina_weibo import topic_list_parser, search_list_parser, topic_detail_parser
from .task_4 import cctv_list_parser, china_list_parser, china_cdc_list_parser, china_news_list_parser
from .task_4 import cnr_list_parser, gov_list_parser, people_list_parser, sina_news_list_parser, xinhua_news_list_parser
...
def get_parser(url: str) -> Optional[Parser]:
    ...
    elif url_components.hostname == 'm.s.weibo.com':
        return topic_detail_parser.TopicDetailParser()
